...
const faqs = [
  {
    ...
    contents: (
      <div>
        The best way is to reach out the team on phone during PST hours if you are unable to access it.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ISO-SJSU is here to help incoming and current students from India in terms of Social, Cultural and Academic aspects of your life and career.
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    contents: (
      <div>
        Yes, if you wish to maintain your F-1 status, you will need to enroll in 12 units as an undergrduate student and 9 units as a graduate student. If you plan on not enrolling in classes, you will need to request a leave of basence by contacting ISSS.
      </div>
    ),
  },
];
