...
const data = [
  ...
  {
    id: 2,
    title: 'Check Their Calendar',
    text:
      'You can check out our Grad advisors availability or a follow-up connect with same advisor again.',
  },
  {
    id: 3,
    title: 'Schedule using Calendly',
    text:
      'Schedule the appointment using Calendly platform with in a minute.',
  },
  {
    id: 4,
    title: 'You are Done!',
    text:
      'Just dont forget to add the meeting to your calendar or update according to your changes.',
  },
];
